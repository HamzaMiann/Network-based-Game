...
void main()  
{
	...
	vec3 tex0_RGB = texture( textSamp00, fUVx2.st + fiTime ).rgb;
	vec3 tex1_RGB = texture( textSamp01, fUVx2.st + fiTime ).rgb;
	vec3 tex2_RGB = texture( textSamp02, fUVx2.st + fiTime ).rgb;
	vec3 tex3_RGB = texture( textSamp03, fUVx2.st + fiTime ).rgb;
	...
	pixelColour.a = 0.8f;
	pixelColour.xyz = vec3(0.1f, 0.3f, 0.9f);
