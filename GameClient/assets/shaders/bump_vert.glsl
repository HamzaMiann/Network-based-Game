...
void main()
{
	...
	//vec3 tex1_RGB = texture( textSamp01, fUVx2.st - iTime * 0.01 ).rgb * 50.f;
	...
	//gl_Position.xyz += length(tex1_RGB) * fNormal.xyz;
	//fVertWorldLocation.xyz += length(tex1_RGB) * fNormal.xyz;
